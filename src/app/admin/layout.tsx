...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="lg:col-span-12 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-3xl glass border border-white/20 shadow-sm">
         ...
         <div className="flex gap-2 p-1 bg-gray-50 rounded-2xl dark:bg-slate-900 border border-gray-100 dark:border-slate-800">
            {tabs.map(tab => {
